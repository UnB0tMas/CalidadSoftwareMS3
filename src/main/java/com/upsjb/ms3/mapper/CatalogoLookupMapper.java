...
public class CatalogoLookupMapper {
    ...
    public ProductoOptionDto toProductoOption(
            Producto entity
    ) {
        if (entity == null) {
            return null;
    ...
    public ProductoSkuOptionDto toProductoSkuOption(
            ProductoSku entity
    ) {
        if (entity == null) {
            return null;
    ...
    public ProveedorOptionDto toProveedorOption(
            Proveedor entity
    ) {
        if (entity == null) {
            return null;
    ...
    public AlmacenOptionDto toAlmacenOption(
            Almacen entity
    ) {
        if (entity == null) {
            return null;
        ...
        return AlmacenOptionDto.builder()
                ...
                .permiteVenta(
                        entity.getPermiteVenta()
                )
                .permiteCompra(
                        entity.getPermiteCompra()
                )
                .estado(
                        entity.getEstado()
                )
    ...
    public PromocionOptionDto toPromocionOption(
            Promocion entity
    ) {
        if (entity == null) {
            return null;
    ...
    public EmpleadoInventarioOptionDto toEmpleadoOption(
    ...
    private String proveedorDisplayName(
            Proveedor entity
    ) {
        if (entity == null) {
            return null;
        ...
        String nombres =
                entity.getNombres() == null
                        ? ""
                        : entity.getNombres().trim();

        String apellidos =
                entity.getApellidos() == null
                        ? ""
                        : entity.getApellidos().trim();
