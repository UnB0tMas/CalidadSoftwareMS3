...
public final class TopicNames {
    ...
    public static final String PRODUCTO_SNAPSHOT =
            "ms3.producto.snapshot.v2";

    public static final String STOCK_SNAPSHOT =
            "ms3.stock.snapshot.v1";

    public static final String PRECIO_SNAPSHOT =
            "ms3.precio.snapshot.v1";

    public static final String PROMOCION_SNAPSHOT =
            "ms3.promocion.snapshot.v1";

    public static final String MOVIMIENTO_INVENTARIO =
