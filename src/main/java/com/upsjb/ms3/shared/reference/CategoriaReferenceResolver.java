...
public class CategoriaReferenceResolver {
    ...
    public Categoria resolve(Long idCategoria, String codigo, String slug, String nombre) {
    ...
    public ReferenceOptionMapper.ReferenceOption toOption(Categoria entity) {
        return optionMapper.toOption(
                ...
                displayResolver.metadata(entity, "codigo", "slug", "nombre", "nivel", "orden")
        );
    }
