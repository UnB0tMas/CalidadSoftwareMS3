...
public class TipoProductoReferenceResolver {

    private final EntityDisplayResolver displayResolver;
    private final ReferenceOptionMapper optionMapper;

    public TipoProducto resolve(Long idTipoProducto, String codigo, String nombre) {
    ...
    public ReferenceOptionMapper.ReferenceOption toOption(TipoProducto entity) {
