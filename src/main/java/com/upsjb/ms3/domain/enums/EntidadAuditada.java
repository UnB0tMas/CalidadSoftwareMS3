...
public enum EntidadAuditada {
    ...
    SKU_ATRIBUTO_VALOR(
            "SKU_ATRIBUTO_VALOR",
            "Valor de atributo de SKU"
    ),

    PRODUCTO_IMAGEN_CLOUDINARY(
            "PRODUCTO_IMAGEN_CLOUDINARY",
            "Imagen Cloudinary de producto"
    ),
    ...
    EMPLEADO_SNAPSHOT_MS2(
            "EMPLEADO_SNAPSHOT_MS2",
            "Snapshot de empleado MS2"
    ),

    EMPLEADO_INVENTARIO_PERMISO(
            "EMPLEADO_INVENTARIO_PERMISO",
            "Permiso de inventario de empleado"
    ),

    PRECIO_SKU_HISTORIAL(
            "PRECIO_SKU_HISTORIAL",
            "Historial de precio de SKU"
    ),
    ...
    COMPRA_INVENTARIO_DETALLE(
            "COMPRA_INVENTARIO_DETALLE",
            "Detalle de compra de inventario"
    ),
    ...
    public static EntidadAuditada fromCode(
            String code
    ) {
        if (
                code == null
