...
public enum TipoEventoAuditoria {
    ...
    CATEGORIA_ATRIBUTO_ASIGNADO(
            "CATEGORIA_ATRIBUTO_ASIGNADO",
            "Atributo asignado a categoría"
    ),

    CATEGORIA_ATRIBUTO_ACTUALIZADO(
            "CATEGORIA_ATRIBUTO_ACTUALIZADO",
            "Asociación de atributo a categoría actualizada"
    ),

    CATEGORIA_ATRIBUTO_ACTIVADO(
            "CATEGORIA_ATRIBUTO_ACTIVADO",
            "Asociación de atributo a categoría activada"
    ),

    CATEGORIA_ATRIBUTO_INACTIVADO(
            "CATEGORIA_ATRIBUTO_INACTIVADO",
            "Asociación de atributo a categoría inactivada"
    ),
    ...
    MOVIMIENTO_KARDEX_REGISTRADO(
            "MOVIMIENTO_KARDEX_REGISTRADO",
            "Movimiento de kardex registrado"
    ),

    EMPLEADO_SNAPSHOT_MS2_REGISTRADO(
            "EMPLEADO_SNAPSHOT_MS2_REGISTRADO",
            "Snapshot de empleado MS2 registrado"
    ),

    EMPLEADO_SNAPSHOT_MS2_ACTUALIZADO(
            "EMPLEADO_SNAPSHOT_MS2_ACTUALIZADO",
            "Snapshot de empleado MS2 actualizado"
    ),

    EMPLEADO_SNAPSHOT_MS2_SINCRONIZADO(
            "EMPLEADO_SNAPSHOT_MS2_SINCRONIZADO",
            "Snapshot de empleado MS2 sincronizado"
    ),
    ...
    EVENTO_KAFKA_FALLIDO(
            "EVENTO_KAFKA_FALLIDO",
            "Evento Kafka fallido"
    ),

    EVENTO_KAFKA_REINTENTADO(
            "EVENTO_KAFKA_REINTENTADO",
            "Evento Kafka reintentado"
    ),
    ...
    public static TipoEventoAuditoria fromCode(
            String code
    ) {
        if (
                code == null
                ...
                .orElseThrow(
                        () ->
                                new IllegalArgumentException(
                                        "Tipo de evento de auditoría no válido: "
                                                + code
                                )
                );
    }
