...
public final class AlmacenSpecifications {
    ...
    public static Specification<Almacen> fromFilter(
    ...
    public static Specification<Almacen> byCodigo(
            String codigo
    ) {
        return SpecificationBuilder.<Almacen>create()
                .activeOnly()
    ...
    public static Specification<Almacen> byNombre(
            String nombre
    ) {
        return SpecificationBuilder.<Almacen>create()
                .activeOnly()
    ...
    public static Specification<Almacen> byPrincipal(
            Boolean principal
    ) {
        return SpecificationBuilder.<Almacen>create()
                .activeOnly()
                .bool(
                        "principal",
                        BooleanCriteria.of(principal)
                )
                .build();
    }

    public static Specification<Almacen> byPermiteVenta(
        ...
        return SpecificationBuilder.<Almacen>create()
                ...
                .bool(
                        "permiteVenta",
                        BooleanCriteria.of(permiteVenta)
                )
                .build();
    }

    public static Specification<Almacen> byPermiteCompra(
        ...
        return SpecificationBuilder.<Almacen>create()
                ...
                .bool(
                        "permiteCompra",
                        BooleanCriteria.of(permiteCompra)
                )
                .build();
    }
